...
class MainMenuScene(Scene):
    def __init__(self):
        self.enter = ui.ButtonUI(pygame.K_RETURN, '[Enter to continue]', 50, 200)
        self.esc = ui.ButtonUI(pygame.K_ESCAPE, '[Esc to quit]', 50, 250)
...
class LevelSelectScene(Scene):
    def __init__(self):
        self.esc = ui.ButtonUI(pygame.K_ESCAPE, '[Esc to quit]', 50, 300)
...
class WinScene(Scene):
    def __init__(self):
        self.alpha = 0
        self.esc = ui.ButtonUI(pygame.K_ESCAPE, '[Esc to quit]', 50, 200)
